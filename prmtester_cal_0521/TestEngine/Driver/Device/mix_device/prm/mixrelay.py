...
class relay(object):
    ...
    def module_init(self):
        ...
        """
        return self.client.relay.module_init()
    ...
    def set_io_switch(self, io_list):
        ...
        """
        return self.client.relay.set_io_switch(io_list)
    ...
    def read_io_status(self, pin_id):
        ...
        :return:
        """
        return self.client.relay.read_io_status(pin_id)
    ...
    def reset_all(self):
        ...
        :return: str "--PASS--"
        :example:
            relay_sg.reset('BASE_BOARD')
        """
        return self.client.relay_sg.reset('BASE_BOARD')
