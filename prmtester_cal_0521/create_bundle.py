...
class CreateBundle(object):
    ...
    def __init__(self, app_name, version, start_up_file, bundle_identifier='www.king.prmeasure'):
    ...
    def mv_resources_folder(self):
        ...
        cmd = r'mv {0}/Contents/Resources/.code/GUI/resources/images/AppIcon.icns "{0}/Contents/Resources/"'.format(
            self._app_path)
        os.system(cmd)
...
if __name__ == '__main__':
    bundle = CreateBundle('TS', '0.0.01', 'main.py')
